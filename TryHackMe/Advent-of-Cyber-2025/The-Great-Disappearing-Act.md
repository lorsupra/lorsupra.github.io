...
<img src="images/01-service-map.png" alt="Service map" style="width:45%">
...
<img src="images/02-security-console-login.png" alt="Security Console login" style="width:45%">
...
<img src="images/05-flag1.png" alt="Flag 1" style="width:45%">
...
<img src="images/06-psych-ward-keycode.png" alt="Psych Ward keycode from camera feed" style="width:45%">
...
<img src="images/07-flag2-part1.png" alt="Flag 2 part 1" style="width:45%">
...
<img src="images/08-scada-terminal.png" alt="SCADA terminal" style="width:45%">
...
<img src="images/09-scada-access.png" alt="SCADA access" style="width:45%">
...
<img src="images/10-unlock-code.png" alt="Unlock code" style="width:45%">

## 11. Final Escape – Flag 3

Entering `739184627` into the bottom key icon on the Security Console unlocked the final door.

<img src="images/11-final-door.png" alt="Final door unlocked" style="width:45%">

<img src="images/12-door-unlocked.png" alt="Door unlocked" style="width:45%">

A door appears at the bottom of the map.

<img src="images/13-exit-door.png" alt="Exit door" style="width:45%">

After clicking the door, you are prompted for all three flags.

<img src="images/14-flag-prompt.png" alt="Flag prompt" style="width:45%">

Challenge complete.

<img src="images/15-challenge-complete.png" alt="Challenge complete" style="width:45%">
